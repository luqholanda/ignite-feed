...
export function Comment(props: CommentProps) {
    ...
    const publishedDateFormatted = format(props.comment.publishedAt, 
                ...
                <div className={styles.commentContent}>
                    <header>
                        <div className={styles.authorAndTime}>
                            ...
                            <time title={publishedDateFormatted} dateTime={props.comment.publishedAt.toString()}>{ publishedDateRelativeToNow }</time>
                        </div>
